...
| Current step | **B.2.4b** (fitted vs unfitted `[0,10]`, cap 16,000; B.2.3's tune finished 2026-09-20 and its theta is baked at 7,185,678) (fitted vs unfitted `[0,10]`) and **B.2.3.3** (5,000 vs 3,900, `[0,3]`), then the `b2core` default flip; **B.2.7** (Colosseum re-tune) after B.2.6 |
