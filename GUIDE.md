...
| Current step | **B.3.3** (RAR-S81's block 1 stopped at iteration 940 with the singular margin on its rail, a registration error; amendment 7 corrects the surface and RAR-S82 registers two 2,000-game reads then the three-block tune, the maintainer's, about 38 h in all). **B.2 closed 2026-09-25**: B.2.7's re-tune (RAR-S78) was baked (`52c46df`, 7,435,006 / EBF 2.457) and its `[0,3]` gate accepted H1 at +13.1 ± 5.4 Elo in 3,081 pairs. **B.3.1** (cluster 2 implementation, `I2`) was **implemented on 2026-09-23**: the `b3proof` arm reads 7,479,114 / EBF 2.467 with the off arm exact, and CI covers it (`analysis/b3_research_2026-09-23.md`, *Final implementation record*). **B.3.2** closed 2026-09-24 (paired run +18.4 ± 9.4 Elo; RAR-S80's categoricals adopt `SingularTtDepthMargin=2` alone); **B.3.3**: the bake (`3ca9aab`, arm 7,978,292 / EBF 2.465) and the curvature sweep are done (3 of 7 coordinates curved, `analysis/b33_sweep_2026-09-24.md`); its SPSA configuration is next, on the B.2.7-baked head (36 coordinates). B.2.6 closed 2026-09-22. **E.3.1** (tag-driven release flow, `I1`, added 2026-09-22) is independent tooling that may land at any point before E.3 |
...
- [ ] **B.3** Cluster 2 — NMP, ProbCut, singular/multi-cut/negative/LDSE extensions, IIR policy; researched on the fitted head 2026-09-23 (RAR-S79); SPRT `[0,3]`; B.3.1 implemented 2026-09-23, B.3.2 closed 2026-09-24, B.3.3 next — **IMPLEMENTED / I2**
    ...
    - [ ] **B.3.3** Bake `SingularTtDepthMargin=2` on the arm (one engine commit), curvature sweep, then the SPSA on Colosseum if curved (maintainer-run); theta baked; bake and sweep done 2026-09-24 (3 of 7 curved), RAR-S81 stopped 2026-09-25 (margin at its rail; registration error), amendment 7 rescaled the surface, RAR-S82 registered the same day: two 2,000-game reads then blocks of 2,000 × 30 under PLAN rule 7c, up to three; **the reads and the chain are the maintainer's** — **IMPLEMENTED / V**
