...
| B.2.2's NPS floor (0.90x pooled PGO) after the review's 0.71x single-build screen | The pooled run reads at or above 0.90x, or B.7 lands the speed work the profile names | B.2.4's gate |
