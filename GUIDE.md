...
| Current step | **B.2.3's tune in sessions** (pilot then N = 5,000, maintainer) with **B.2.4a** (the `[0,10]` gate of the unfitted `b2core` arm, binaries registered in RAR-S73) run between sessions; then **B.2.4b** |
