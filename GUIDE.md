...
- [ ] **B.2** Cluster 1 — selectivity core: TT eval storage, correction, histories, picker, move-loop pruning, LMR; both gates passed and the fitted core is the default build, open only for the harness leaves B.2.6 and B.2.7 — **GAME_GATE / I2**
