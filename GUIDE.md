...
| Current step | **B.2.3** (preparation `I1`: tooling ticket, config and fixed file, coverage audit, RAR-S75 registration; then the maintainer runs the pilot and the N = 5,000 tune in sessions), then **B.2.4** (the `[0,10]` gate) |
