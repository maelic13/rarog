...
| Current step | **B.2.7** (re-tune on Colosseum, RAR-S78): registered and handed over 2026-09-22, the 150,000-game tune and its `[0,3]` gate are the maintainer's to run; it closes B.2; **B.3.1** (cluster 2 implementation, `I2`) was **returned to RESEARCH on 2026-09-23 after T1 and T2**: two packet premises failed on live counters (`analysis/b3_research_2026-09-23.md`, Unknowns 6–7). T3 and T4 wait for the packet's amendment; the leaf's games still come after the tune's sessions. B.2.6 closed 2026-09-22. **E.3.1** (tag-driven release flow, `I1`, added 2026-09-22) is independent tooling that may land at any point before E.3 |
...
|---|---|---|
| B.3.1 returned to RESEARCH after T1–T2 (`2b9507b`), 2026-09-23: ProbCut's donor verification cannot lower survival, and the null-move region is inert at bench depth | A research amendment of the packet chooses among options (a)–(c) in its *B.3.1 implementation record* (recommended: (a)) and re-registers P4's survival leg; T3 then resumes | B.3.2 |
...
- [ ] **B.3** Cluster 2 — NMP, ProbCut, singular/multi-cut/negative/LDSE extensions, IIR policy; researched on the fitted head 2026-09-23 (RAR-S79); SPRT `[0,3]`; back in research after B.3.1's T2 — **RESEARCH / I2**
    - [ ] **B.3.1** Implement behind `b3proof`: NMP at cut nodes with a verification region, ProbCut's donor depth and return, graded singular/multi-cut/LDSE and the LMR term, IIR switch; off arm exact. T1–T2 built 2026-09-23, then returned: ProbCut's survival premise and the region's premise failed on live counters (packet Unknowns 6–7) — **RESEARCH / I2**
