...
| Active experiment | **RAR-S73** (B.2 selectivity core: B.2.4a passed 2026-09-16, +65.09 ± 23.26; B.2.3's tune running, RAR-S75; B.2.4b pending); **RAR-M45, RAR-M46, RAR-O03 and RAR-M48 all resolved 2026-09-11**; RAR-M49 conversion re-read and RAR-M50 (B.0 measurements) recorded 2026-09-13; RAR-M54 (Super Rating Tournament read, 42 engines) recorded 2026-09-15, nothing moves. **D.2's premise is contradicted by RAR-M46 and the leaf needs re-scoping** |
| Current step | **B.2.3's tune in sessions** (at 250 of 5,000 after the update restart; resume with `-LaunchOnly -Iterations 5000`), then **B.2.4b** (fitted vs unfitted `[0,10]`), then the `b2core` default flip |
...
| B.2.3's pilot and N = 5,000 tune (maintainer-run, RAR-S75) | The maintainer runs the pilot, the surface is re-audited, the tune completes in sessions and the final theta is pasted | B.2.4 starts |
