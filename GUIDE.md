...
| Current step | **B.2.0 — the review's twelve behaviour-neutral upgrade tickets** (review done 2026-09-14, RAR-M51), then B.2.1 |
...
the B.1 NPS pool; the `Searcher` split it designed is B.2.1's ticket 0. Then
