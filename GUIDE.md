...
| Active experiment | **RAR-S73** (B.2 selectivity core: B.2.4a passed 2026-09-16, +65.09 ± 23.26; B.2.3's tune at 3,900 of 5,000, RAR-S75; RAR-S76 peek at 3,900 +118.72 ± 10.62; RAR-M55 and RAR-M56 (B.2.3.2 closed: fitted +97.69, unfitted −7.12 vs Rybka 4.1), RAR-S77 (B.2.3.3) and RAR-S78 (B.2.7) registered; B.2.4b pending); **RAR-M45, RAR-M46, RAR-O03 and RAR-M48 all resolved 2026-09-11**; RAR-M49 conversion re-read and RAR-M50 (B.0 measurements) recorded 2026-09-13; RAR-M54 (Super Rating Tournament read, 42 engines) recorded 2026-09-15, nothing moves. **D.2's premise is contradicted by RAR-M46 and the leaf needs re-scoping** |
| Current step | **B.2.3's tune in sessions** (at 3,900 of 5,000 on 2026-09-19; resume with `-LaunchOnly -Iterations 5000`), then **B.2.4b** (fitted vs unfitted `[0,10]`) and **B.2.3.3** (5,000 vs 3,900, `[0,3]`), then the `b2core` default flip; **B.2.7** (Colosseum re-tune) after B.2.6 |
...
| B.2.3's N = 5,000 tune (maintainer-run, RAR-S75) | Pilot done; the tune completes in sessions (3,900 of 5,000 on 2026-09-19) and the final theta is pasted | B.2.4b and B.2.3.3 start |
