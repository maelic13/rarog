...
- [ ] **B.3** Cluster 2 — NMP, ProbCut, singular/multi-cut/negative/LDSE extensions, IIR policy; researched on the fitted head 2026-09-23 (RAR-S79); SPRT `[0,3]`; B.3.1 implemented 2026-09-23, B.3.2 closed 2026-09-24, B.3.3 next — **IMPLEMENTED / I2**
    ...
    - [ ] **B.3.3** Bake `SingularTtDepthMargin=2` on the arm (one engine commit), curvature sweep, then the SPSA on Colosseum if curved (maintainer-run); theta baked; bake and sweep done 2026-09-24 (3 of 7 curved), SPSA configuration held on RAR-S78's bake — **READY_FOR_IMPLEMENTATION / V**
