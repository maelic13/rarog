...
| Fingerprint | `bench 13` **7,435,006 / EBF 2.457**: the selectivity core with RAR-S78's re-tuned theta baked (`52c46df`) and accepted by its gate on 2026-09-25 at +13.1 ± 5.4 Elo (RAR-S78); before it the B.2.3-fitted core read 7,185,678 / EBF 2.444, the default since B.2.4b (2026-09-20, `a47e85b`). `--no-default-features` compiles the superseded B.1 search at 7,601,220 / EBF 2.474 — the 2.4.0 fingerprint, accepted by RAR-E15 and reproduced in A.7, A.8.3 and A.8.4 — until B.8 deletes it | GUIDE checkpoint; RAR-S73; RAR-M48 manifests |
...
- **B.2 Cluster 1 — the selectivity core — `I2`, then `V`.** **B.0 handoff
  ...
  separately. Sub-steps:
    ...
    - **B.2.7 Re-tune of the most-moved B.2.3 coordinates on Colosseum —
      ...
      faults; the re-tuned theta stays and B.2 closes.** The gain came
      with coordinates B.2.3 had left near their seeds moving a step
      together, which reads as coupling rather than travel; the horizon
      was not the limit, the seeds were.
  ...
  **Researched 2026-09-23 on the fitted head (`analysis/b3_research_2026-09-23.md`,
  ...
  agreement 41/50, canaries 87/116.
    - **B.3.1 Implement — `I2`, IMPLEMENTED 2026-09-23.** The `b3proof` arm
      ...
      position 15 at depth 19 (4.11×). The arm finishes every depth the
      head finishes, and seldepth 127 persists in both engines (packet
      Unknown 11). Fourth return, resolved by amendment 5: (a1), `alpha` for a lone
      ...
      screen runs.
    - **B.3.2 Diagnostics — `V`, GAME_GATE: the paired run played 2026-09-24.**
...
- **B.5 Cluster 4 — root, aspiration, iterative deepening — `I2`, then `V`.**
  **Note from B.3 (2026-09-23):** at deep iterations (depth 19 and up on
  ...
  `new_depth + 2`, the deeper re-search, hindsight, the PV extension); B.3
  bounded only the singular chain. Whether deep-iteration line growth needs
  a bound is this cluster's question.
