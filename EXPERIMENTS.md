...
| RAR-M08 | The 36,400-game 2026-08-05 rating tournament uses a 2.4-dev binary with interim values from an unfinished aspiration SPSA. | **Observation only:** at 8,626 games it was +11 pool Elo over 2.3.1 and 39 below Basilisk 1.9.3. No component attribution or acceptance follows. | A mixed unfinished binary can locate a possible gap but cannot establish a candidate's value. Plan 4.0 archives both jobs and restores one clean comparator. | `PLAN.md` §1, 4.0 |
